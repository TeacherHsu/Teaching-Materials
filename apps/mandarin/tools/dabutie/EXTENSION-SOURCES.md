...
## 教育百科「生字詞彙表」：目標字詞的官方交叉核對來源（2026-09-25，CF 提供）

- 課次列表：`https://pedia.cloud.edu.tw/Bookmark/Textword?category=國語&year=115_1&degree=3&press=翰林版`
- 單課：`https://pedia.cloud.edu.tw/Bookmark/TCollection?TextNameId=0101031150101`（第 1 課）。列表頁的「前往」連結是各課的 TextNameId，**不要自行推算 ID**。
- 內容：每課的「生字」（附字義）與「語詞」（附解釋與例句）。頁面上有「匯出所有詞條 Excel」。
- 第 1 課實測有 24 筆：15 個生字，加上 9 個語詞（等待、蝸牛、慢吞吞、忙碌、飛奔、彈簧、縮短、悲傷、流水）。大補帖 05 語詞解釋有 13 筆，多出來的 牠、寸、它、永 是單字生字，兩個來源一致。
- 用途：匯入時交叉核對 05 抽到的目標語詞；日後加入沒有大補帖的版本時，可以當作語詞主來源。字義與例句的授權依教育百科規定，例句仍比照改寫規則處理。
